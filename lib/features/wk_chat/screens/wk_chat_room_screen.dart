...
class WkChatRoomScreen extends ConsumerStatefulWidget {
  final String conversationId;

  const WkChatRoomScreen({super.key, required this.conversationId});

  @override
  ConsumerState<WkChatRoomScreen> createState() => _WkChatRoomScreenState();
}

class _WkChatRoomScreenState extends ConsumerState<WkChatRoomScreen> {
  ...
  Future<void> _load({bool silent = false}) async {
    try {
      ...
      await repo.markConversationReadByWorker(widget.conversationId);
                    ...
                    children: [
                      if (showTimeDivider)
                        Padding(
                          ...
                          child: Text(
                            '${wkChatRelativeDateLabel(message.createdAtUtc7)}, ${wkChatTimeLabel(message.createdAtUtc7)}',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Date: ${wkChatRelativeDateLabel(contextData.scheduledAtUtc7)}, ${wkChatTimeLabel(contextData.scheduledAtUtc7)}',
                ),
                const SizedBox(height: 6),
...
class _MessageBubble extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isWorker = message.isFromWorker;
    final scheme = Theme.of(context).colorScheme;

    final bgColor = isWorker ? AppColors.primary : scheme.surface;
    final textColor = isWorker ? Colors.white : scheme.onSurface;
    final align = isWorker ? Alignment.centerRight : Alignment.centerLeft;
      ...
      child: ConstrainedBox(
        ...
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (message.type == WkChatMessageType.image &&
